...
* Wie Sie oben sehen, ist $\mathbf{x}_i$ aus mathematischer Sicht ein Spaltenvektor. Mit diesem Spaltenvektor können wir die Input-Daten einer Beobachtung *kompakt* darstellen können.
...
### Taxonomie des Machine Learnings {#sec-taxonomie}
